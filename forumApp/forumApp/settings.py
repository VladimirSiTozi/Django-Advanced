...
AUTHENTICATION_BACKENDS = [
    ...
    'django.contrib.auth.backends.ModelBackend',  # not really needed
]
...
# SESSION_COOKIE_HTTPONLY = True  # This means that the cookie cannot be accessed or manipulated by JavaScript in the browser.
# SESSION_COOKIE_SECURE = True  # session cookie is only sent over HTTPS connections.
# CSRF_COOKIE_HTTPONLY = True  # preventing JavaScript from accessing it directly
